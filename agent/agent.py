...
class SHLAgent:
    ...
    def _extract_facts(self, messages):
        ...
        skill_words = [
            ...
            '365', 'office 365', 'microsoft 365',
            'safety', 'dependability', 'workplace health', 'customer service', 'call center', 'contact center',
    ...
    def _build_query(self, facts, type_hint=None):
        ...
        role_synonyms = {
            ...
            'admin assistant':       'administrative clerical office ms excel word 365',
            'administrative assistant': 'administrative clerical office ms excel word 365',
            'plant operator':        'manufacturing industrial safety chemical dependability workplace health',
